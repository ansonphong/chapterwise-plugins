...
/meta-loop-gap plans/vace
/meta-loop-gap plans/new-image-pipelines
...
|-----------------|------|-------------|
| Path inside `plans/` or directory containing only `.md` files | **plan** | Scan plan docs for cross-reference consistency |
