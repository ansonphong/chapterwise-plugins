...
- [ ] **Task 3:** Copy existing commands from chapterwise (insert.md)
  - Test: `ls plugins/chapterwise/commands/insert.md && echo PASS`
  - Files: `plugins/chapterwise/commands/insert.md`

- [ ] **Task 4:** Copy analysis modules from chapterwise-analysis
...
- [ ] **Task 5:** Copy scripts from chapterwise-codex and chapterwise-analysis
...
- [ ] **Task 6:** Build recipe infrastructure scripts (`recipe_manager.py`, `codex_validator.py`, `recipe_validator.py`)
...
- [ ] **Task 10:** Verify existing module_loader.py works from new location
...
- [ ] **CHECKPOINT Phase 1:** Scaffold verification + code review
...
- [ ] **Task 15:** Build `patterns/plaintext_converter.py` (simplest converter)
...
- [ ] **Task 17:** Write `commands/import-scrivener.md` (alias)
...
- [ ] **CHECKPOINT Phase 2:** Import recipe verification + code review
...
- [ ] **Task 19 [PARALLEL-A]:** Analysis Recipe — Write `commands/analysis.md`
...
- [ ] **Task 20 [PARALLEL-A]:** Analysis — Update `scripts/module_loader.py` with courses + recommend
...
- [ ] **Task 21 [PARALLEL-B]:** Atlas Recipe — Write `commands/atlas.md`
  - Agent: Task(subagent_type="general-purpose", isolation="worktree")
...
- [ ] **Task 22 [PARALLEL-C]:** Reader Recipe — Write `commands/reader.md`
  - Agent: Task(subagent_type="general-purpose", isolation="worktree")
...
- [ ] **Task 23 [PARALLEL-C]:** Reader — Build `templates/minimal-reader/`
...
- [ ] **Task 24 [PARALLEL-C]:** Reader — Build `templates/academic-reader/`
...
- [ ] **CHECKPOINT Phase 3:** Merge worktrees + verify all recipe commands exist
...
- [ ] **Task 27:** Build `patterns/scrivener_converter.py` (adapt from existing)
...
- [ ] **CHECKPOINT Phase 4:** All patterns compile + code review
...
- [ ] **CHECKPOINT Phase 5:** Cross-cutting commands + code review
...
- [ ] **Task 35:** Remove old `chapterwise/commands/import.md` (replaced by recipe version)
...
- [ ] **CHECKPOINT Phase 6:** Migration stubs + old commands redirected
