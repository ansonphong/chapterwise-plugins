#!/usr/bin/env python3
"""
structure_analyzer.py — Thin wrapper for the import command.

Accepts the path-based stdin interface used by import.md and delegates
to the real implementation in patterns/common/structure_analyzer.py.

Input  (stdin):  {"path": "/path/to/file", "format": "plaintext"}
Output (stdout): JSON structure analysis result
"""
